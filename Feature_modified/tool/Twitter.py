...
#NEW FEATURES START HERE:
    def get_avg_word_length(self):
        '''
        Calculate average word length in tweet text
        '''
    ...
    def get_exclamation_count(self):
        '''
        Count the number of exclamation marks in tweet text
        '''
    ...
    def get_tweet_features(self):
        ...
        feature_list.append(self.get_avg_word_length())         # 14 (NEWLY ADDED)
        feature_list.append(self.get_exclamation_count())       # 15 (NEWLY ADDED)
